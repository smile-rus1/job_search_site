...
from src.dto.infustructure.user.user import CreateUserDTODAO, OutUserDTODAO, UserDTODAO, BaseUserDTODAO
...
class UserDAO(BaseDAO):
    async def create(self, user: CreateUserDTODAO) -> OutUserDTODAO:
